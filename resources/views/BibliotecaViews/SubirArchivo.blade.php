...
<body>
    ...
    <nav class="navbar navbar-light bg-white shadow-sm mb-4">
        <div class="container">
            <a class="navbar-brand fw-bold" href="/biblioteca" style="color: var(--cetis-rojo);">
            ...
            <div class="col-md-8 col-lg-6">
                ...
                <div class="form-container shadow">
                    <div class="text-center mb-4">
                        <i class="bi bi-cloud-arrow-up-fill display-4" style="color: var(--cetis-rojo);"></i>
                    ...
                    <form action="{{ route('biblioteca.guardar') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text text-danger"><i class="bi bi-info-circle"></i> Solo se permiten archivos en formato PDF (Máx. 10MB).</div>
                        </div>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="/biblioteca" class="btn btn-outline-secondary">Cancelar</a>
                        </div>
                ...
                <p class="text-center mt-4 text-muted small">
                    © 2025 CETIS 17 | Al subir archivos asegúrate de que no infrinjan derechos de autor.
                </p>
            </div>
        </div>
    </div>
